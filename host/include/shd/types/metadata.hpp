...
#ifndef INCLUDED_SHD_TYPES_METADATA_HPP
#define INCLUDED_SHD_TYPES_METADATA_HPP
...
namespace shd{
     ...
     */
    struct SHD_API async_metadata_t{
...
#endif /* INCLUDED_SHD_TYPES_METADATA_HPP */
