...
#ifndef INCLUDED_SHD_SMINI_FE_CONNECTION_HPP
#define INCLUDED_SHD_SMINI_FE_CONNECTION_HPP
...
namespace shd { namespace smini {
    ...
    class SHD_API fe_connection_t : boost::equality_comparable<fe_connection_t> {
    public:
        /** Sampling mode.
     ...
     */
    SHD_API bool operator==(const fe_connection_t &lhs, const fe_connection_t &rhs);

}} //namespace

#endif /* INCLUDED_SHD_SMINI_FE_CONNECTION_HPP */
