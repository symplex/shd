...
#ifndef INCLUDED_SHD_TRANSPORT_USB_ZERO_COPY_HPP
#define INCLUDED_SHD_TRANSPORT_USB_ZERO_COPY_HPP
 ...
 */
class SHD_API usb_zero_copy : public virtual zero_copy_if {
public:
...
#endif /* INCLUDED_SHD_TRANSPORT_USB_ZERO_COPY_HPP */
