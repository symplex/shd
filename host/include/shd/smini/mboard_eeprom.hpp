...
#ifndef INCLUDED_SHD_SMINI_MBOARD_EEPROM_HPP
#define INCLUDED_SHD_SMINI_MBOARD_EEPROM_HPP
...
namespace shd{ namespace smini{
     ...
     * Knows how to read and write the EEPROM for various SMINIs.
     ...
     */
    struct SHD_API mboard_eeprom_t : shd::dict<std::string, std::string>{
...
#endif /* INCLUDED_SHD_SMINI_MBOARD_EEPROM_HPP */
