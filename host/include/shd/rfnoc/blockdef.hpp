...
#ifndef INCLUDED_LIBSHD_RFNOC_BLOCKDEF_HPP
#define INCLUDED_LIBSHD_RFNOC_BLOCKDEF_HPP
 ...
 */
class SHD_RFNOC_API blockdef : public boost::enable_shared_from_this<blockdef>
{
public:
    ...
    //
    // This is not the same as a shd::rfnoc::stream_sig_t. This is used
    ...
    class port_t : public shd::dict<std::string, std::string> {
      public:
    ...
    class arg_t : public shd::dict<std::string, std::string> {
      public:
    ...
    typedef shd::dict<std::string, size_t> registers_t;
    ...
    //
    // \throws shd::runtime_error if args are invalid.
...
#endif /* INCLUDED_LIBSHD_RFNOC_BLOCKDEF_HPP */
// vim: sw=4 et:
