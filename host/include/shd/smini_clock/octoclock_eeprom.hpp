...
#ifndef INCLUDED_SHD_SMINI_CLOCK_OCTOCLOCK_EEPROM_HPP
#define INCLUDED_SHD_SMINI_CLOCK_OCTOCLOCK_EEPROM_HPP
 ...
 */
class SHD_API octoclock_eeprom_t : public shd::dict<std::string, std::string>{
public:
...
#endif /* INCLUDED_SHD_SMINI_CLOCK_OCTOCLOCK_EEPROM_HPP */
