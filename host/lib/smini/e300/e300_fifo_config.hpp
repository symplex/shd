...
struct e300_fifo_interface : boost::enable_shared_from_this<e300_fifo_interface>
{
    ...
    virtual shd::transport::zero_copy_if::sptr make_recv_xport(
        const size_t which_stream,
        const shd::transport::zero_copy_xport_params &params) = 0;

    virtual shd::transport::zero_copy_if::sptr make_send_xport(
        const size_t which_stream,
        const shd::transport::zero_copy_xport_params &parms) = 0;
