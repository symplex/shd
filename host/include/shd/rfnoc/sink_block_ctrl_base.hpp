...
#ifndef INCLUDED_LIBSHD_TX_BLOCK_CTRL_BASE_HPP
#define INCLUDED_LIBSHD_TX_BLOCK_CTRL_BASE_HPP
 ...
 */
class SHD_RFNOC_API sink_block_ctrl_base;
...
#endif /* INCLUDED_LIBSHD_TX_BLOCK_CTRL_BASE_HPP */
// vim: sw=4 et:
