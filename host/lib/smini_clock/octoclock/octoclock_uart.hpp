 ...
 */
namespace shd{
class octoclock_uart_iface : public shd::uart_iface{
public:
    octoclock_uart_iface(shd::transport::udp_simple::sptr udp, uint32_t proto_ver);
...
private:
    shd::transport::udp_simple::sptr _udp;
...
uart_iface::sptr octoclock_make_uart_iface(shd::transport::udp_simple::sptr udp, uint32_t proto_ver);
