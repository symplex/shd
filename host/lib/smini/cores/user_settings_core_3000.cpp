...
public:
    ...
    {
        if (offset % sizeof(uint64_t) != 0) throw shd::value_error("poke64: Incorrect address alignment");
    ...
    {
        if (offset % sizeof(uint64_t) != 0) throw shd::value_error("peek64: Incorrect address alignment");
    ...
    {
        if (offset % sizeof(uint32_t) != 0) throw shd::value_error("poke32: Incorrect address alignment");
    ...
    {
        if (offset % sizeof(uint32_t) != 0) throw shd::value_error("peek32: Incorrect address alignment");
