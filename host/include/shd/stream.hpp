 ...
 * // (We assume that smini is a valid shd::smini::multi_smini)
...
struct SHD_API stream_args_t{
     ...
     * (a SMINI N210 can work with 25 MHz bandwidth for 16-Bit complex samples, and 50 MHz for 8-Bit
     * complex samples).
     */
     ...
     * the channels are switched and the first channel of the SMINI is mapped to
     ...
     * a single channel from the B-side radio of a SMINI, this is a more versatile solution
 ...
 */
class SHD_API rx_streamer : boost::noncopyable{
public:
 ...
 */
class SHD_API tx_streamer : boost::noncopyable{
public:
