...
#ifndef INCLUDED_SHD_TRANSPORT_UDP_SIMPLE_HPP
#define INCLUDED_SHD_TRANSPORT_UDP_SIMPLE_HPP
...
class SHD_API udp_simple : boost::noncopyable{
public:
...
#endif /* INCLUDED_SHD_TRANSPORT_UDP_SIMPLE_HPP */
