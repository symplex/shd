...
std::string e300_get_sysfs_attr(const std::string &node, const std::string &attr)
{
    ...
    if (!udev) {
        throw shd::lookup_error("Failed to get udev handle.");
    }
...
e300_fifo_config_t e300_read_sysfs(void)
{
    ...
    {
        throw shd::runtime_error("E300 FPGA load failed!");
    }
...
e300_fifo_config_t e300_read_sysfs(void)
{
    throw shd::assertion_error("e300_read_sysfs() !E300_NATIVE");
}

std::string e300_get_sysfs_attr(const std::string &, const std::string &)
{
    throw shd::assertion_error("e300_sysfs_attr() !E300_NATIVE");
}
