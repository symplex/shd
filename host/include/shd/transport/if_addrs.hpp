...
#ifndef INCLUDED_SHD_TRANSPORT_IF_ADDRS_HPP
#define INCLUDED_SHD_TRANSPORT_IF_ADDRS_HPP
...
namespace shd{ namespace transport{
     ...
     */
    SHD_API std::vector<if_addrs_t> get_if_addrs(void);

}} //namespace


#endif /* INCLUDED_SHD_TRANSPORT_IF_ADDRS_HPP */
