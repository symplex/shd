...
#ifndef INCLUDED_LIBSHD_SINK_NODE_CTRL_BASE_HPP
#define INCLUDED_LIBSHD_SINK_NODE_CTRL_BASE_HPP
 ...
 */
class SHD_RFNOC_API sink_node_ctrl;
...
#endif /* INCLUDED_LIBSHD_SINK_NODE_CTRL_BASE_HPP */
// vim: sw=4 et:
