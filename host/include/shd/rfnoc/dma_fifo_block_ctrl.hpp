...
#ifndef INCLUDED_LIBSHD_RFNOC_DMA_FIFO_BLOCK_HPP
#define INCLUDED_LIBSHD_RFNOC_DMA_FIFO_BLOCK_HPP
 ...
 *
 */
class SHD_RFNOC_API dma_fifo_block_ctrl : public source_block_ctrl_base, public sink_block_ctrl_base
{
public:
    SHD_RFNOC_BLOCK_OBJECT(dma_fifo_block_ctrl)
...
#endif /* INCLUDED_LIBSHD_RFNOC_DMA_FIFO_BLOCK_HPP */
