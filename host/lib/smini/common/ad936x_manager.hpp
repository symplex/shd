 ...
 * It requires a shd::smini::ad9361_ctrl object to do the actual
...
public:
     ...
     *
     * \throws a shd::runtime_error if the loopback value didn't match.
     */
     ...
     * \throws a shd::value_error if \p lcm_rate exceeds the max tick rate
     */
    ...
    virtual void populate_frontend_subtree(
            shd::property_tree::sptr subtree,
