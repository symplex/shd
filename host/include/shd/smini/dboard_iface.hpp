...
#ifndef INCLUDED_SHD_SMINI_DBOARD_IFACE_HPP
#define INCLUDED_SHD_SMINI_DBOARD_IFACE_HPP
...
struct SHD_API dboard_iface_special_props_t{
    /*!
     * Soft clock divider:
 ...
 */
class SHD_API dboard_iface : public shd::i2c_iface{
public:
    ...
    typedef shd::smini::gpio_atr::gpio_atr_reg_t atr_reg_t;
     ...
     */
    virtual shd::time_spec_t get_command_time(void) = 0;

    /*!
     * Set the command time.
     * \param t the time
     */
    virtual void set_command_time(const shd::time_spec_t& t) = 0;
...
#endif /* INCLUDED_SHD_SMINI_DBOARD_IFACE_HPP */
