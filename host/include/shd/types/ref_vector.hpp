...
#ifndef INCLUDED_SHD_TYPES_REF_VECTOR_HPP
#define INCLUDED_SHD_TYPES_REF_VECTOR_HPP
 ...
 */
template <typename T> class SHD_API ref_vector{
public:
    /*!
...
#endif /* INCLUDED_SHD_TYPES_REF_VECTOR_HPP */
