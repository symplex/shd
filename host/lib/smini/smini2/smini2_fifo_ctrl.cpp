...
class smini2_fifo_ctrl_impl : public smini2_fifo_ctrl{
public:

    smini2_fifo_ctrl_impl(zero_copy_if::sptr xport):
        _xport(xport),
        _seq_out(0),
        _seq_ack(0),
...
smini2_fifo_ctrl::sptr smini2_fifo_ctrl::make(zero_copy_if::sptr xport){
    return sptr(new smini2_fifo_ctrl_impl(xport));
}
