...
#ifndef INCLUDED_LIBSHD_TICK_NODE_CTRL_BASE_HPP
#define INCLUDED_LIBSHD_TICK_NODE_CTRL_BASE_HPP
 ...
 */
class SHD_RFNOC_API tick_node_ctrl;
...
#endif /* INCLUDED_LIBSHD_TICK_NODE_CTRL_BASE_HPP */
// vim: sw=4 et:
