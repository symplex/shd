...
########################################################################
def get_options():
    parser = argparse.ArgumentParser(description='Controller for the SMINI X3X0 Aurora BIST Engine')
    parser.add_argument('--master', type=str, default=None, required=True, help='IP Address of master SMINI-X3X0 device')
    parser.add_argument('--slave', type=str, default=None, help='IP Address of slave SMINI-X3X0 device')
