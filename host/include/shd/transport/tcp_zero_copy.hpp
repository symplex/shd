...
#ifndef INCLUDED_SHD_TRANSPORT_TCP_ZERO_COPY_HPP
#define INCLUDED_SHD_TRANSPORT_TCP_ZERO_COPY_HPP
 ...
 * This transport provides the shd zero copy interface
 * on top of a standard tcp socket from boost asio.
 */
struct SHD_API tcp_zero_copy : public virtual zero_copy_if
{
...
#endif /* INCLUDED_SHD_TRANSPORT_TCP_ZERO_COPY_HPP */
