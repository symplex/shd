...
#ifndef INCLUDED_LIBSHD_SMINI_RX_VITA_CORE_3000_HPP
#define INCLUDED_LIBSHD_SMINI_RX_VITA_CORE_3000_HPP
...
public:
    ...
    virtual void issue_stream_command(const shd::stream_cmd_t &stream_cmd) = 0;
...
#endif /* INCLUDED_LIBSHD_SMINI_RX_VITA_CORE_3000_HPP */
