...
struct n230_uart_impl : n230_uart
{
        ...
        _char_queue(4096)
    {
        ...
        _recv_task = shd::task::make(boost::bind(&n230_uart_impl::handle_recv, this));
    }
    ...
    void send_char(const char ch)
    {
        ...
        packet_buff[packet_info.num_header_words32+0] = shd::htonx(uint32_t(_baud_div));
        packet_buff[packet_info.num_header_words32+1] = shd::htonx(uint32_t(ch));
    ...
    void handle_recv(void)
    {
        ...
        const char ch = char(shd::ntohx(packet_buff[packet_info.num_header_words32+1]));
