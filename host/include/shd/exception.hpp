...
#ifndef INCLUDED_SHD_EXCEPTION_HPP
#define INCLUDED_SHD_EXCEPTION_HPP
 ...
 * - Exceptions inherit from shd::exception to provide code().
 *
...
namespace shd{
    ...
    struct SHD_API exception : std::runtime_error{
    ...
    struct SHD_API assertion_error : exception{
    ...
    struct SHD_API lookup_error : exception{
    ...
    struct SHD_API index_error : lookup_error{
    ...
    struct SHD_API key_error : lookup_error{
    ...
    struct SHD_API type_error : exception{
    ...
    struct SHD_API value_error : exception{
    ...
    struct SHD_API runtime_error : exception{
    ...
    struct SHD_API usb_error : runtime_error{
        int _code;
    ...
    struct SHD_API not_implemented_error : runtime_error{
    ...
    struct SHD_API environment_error : exception{
    ...
    struct SHD_API io_error : environment_error{
    ...
    struct SHD_API os_error : environment_error{
    ...
    struct SHD_API system_error : exception{
    ...
    struct SHD_API syntax_error : exception{
     ...
     */
    #define SHD_THROW_SITE_INFO(what) std::string( \
        std::string(what) + "\n" + \
     ...
     */
    #define SHD_THROW_INVALID_CODE_PATH() \
        throw shd::system_error(SHD_THROW_SITE_INFO("invalid code path"))
     ...
     */
    #define SHD_ASSERT_THROW(code) {if (not (code)) \
        throw shd::assertion_error(SHD_THROW_SITE_INFO(#code)); \
    }

} //namespace shd

#endif /* INCLUDED_SHD_EXCEPTION_HPP */
