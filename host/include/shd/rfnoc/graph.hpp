...
#ifndef INCLUDED_LIBSHD_RFNOC_GRAPH_HPP
#define INCLUDED_LIBSHD_RFNOC_GRAPH_HPP
...
{
public:
    typedef boost::shared_ptr<shd::rfnoc::graph> sptr;
...
}}; /* name space shd::rfnoc */

#endif /* INCLUDED_LIBSHD_RFNOC_GRAPH_HPP */
// vim: sw=4 et:
