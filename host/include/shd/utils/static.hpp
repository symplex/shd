...
#ifndef INCLUDED_SHD_UTILS_STATIC_HPP
#define INCLUDED_SHD_UTILS_STATIC_HPP
 ...
 */
#define SHD_SINGLETON_FCN(_t, _x) static _t &_x(){static _t _x; return _x;}
 ...
 */
#define SHD_STATIC_BLOCK(_x) \
    void _x(void); \
    static _shd_static_fixture _x##_fixture(&_x, #_x); \
    void _x(void)

//! Helper for static block, constructor calls function
struct SHD_API _shd_static_fixture{
    _shd_static_fixture(void (*)(void), const char *);
};

#endif /* INCLUDED_SHD_UTILS_STATIC_HPP */
