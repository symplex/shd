...
#ifndef INCLUDED_LIBSHD_SMINI_RX_DSP_CORE_3000_HPP
#define INCLUDED_LIBSHD_SMINI_RX_DSP_CORE_3000_HPP
...
public:
    ...
    virtual void set_mux(const shd::smini::fe_connection_t& fe_conn) = 0;
...
#endif /* INCLUDED_LIBSHD_SMINI_RX_DSP_CORE_3000_HPP */
