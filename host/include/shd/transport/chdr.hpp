...
#ifndef INCLUDED_SHD_TRANSPORT_CHDR_HPP
#define INCLUDED_SHD_TRANSPORT_CHDR_HPP

#include <shd/transport/vrt_if_packet.hpp>

namespace shd{ namespace transport{ namespace vrt{
...
}}} //namespace shd::transport::vrt

#endif /* INCLUDED_SHD_TRANSPORT_CHDR_HPP */
