...
#ifndef INCLUDED_SHD_TRANSPORT_NIRIO_STATUS_H
#define INCLUDED_SHD_TRANSPORT_NIRIO_STATUS_H
...
SHD_API const std::string lookup_err_msg(nirio_status code);

SHD_API void nirio_status_to_exception(const nirio_status& status, const std::string& message);
}}
...
#endif /* INCLUDED_SHD_TRANSPORT_NIRIO_STATUS_H */
