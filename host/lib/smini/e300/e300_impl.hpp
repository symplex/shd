...
static const std::string E300_FPGA_FILE_NAME = "smini_e300_fpga.bit";
static const std::string E310_SG1_FPGA_FILE_NAME = "smini_e310_fpga.bit";
static const std::string E310_SG3_FPGA_FILE_NAME = "smini_e310_fpga_sg3.bit";

static const std::string E3XX_SG1_FPGA_IDLE_FILE_NAME = "smini_e3xx_fpga_idle.bit";
static const std::string E3XX_SG3_FPGA_IDLE_FILE_NAME = "smini_e3xx_fpga_idle_sg3.bit";
...
shd::device_addrs_t e300_find(const shd::device_addr_t &multi_dev_hint);
void get_e3x0_fpga_images(const shd::device_addr_t &device_args,
                          std::string &fpga_image,
                          std::string &idle_image);

/*!
 * SMINI-E300 implementation guts:
 * The implementation details are encapsulated here.
 * Handles properties on the mboard, dboard, dsps...
 */
class e300_impl : public shd::device
{
public:
    //structors
    e300_impl(const shd::device_addr_t &);
...
private: // methods
    void _register_loopback_self_test(shd::wb_iface::sptr iface);
    ...
    void _set_time(const shd::time_spec_t&);
    ...
    void _codec_loopback_self_test(shd::wb_iface::sptr iface);
    ...
    shd::sensor_value_t _get_fe_pll_lock(const bool is_tx);

private: // members
    shd::device_addr_t                     _device_addr;
    xport_t                                _xport_path;
    ...
    shd::transport::zero_copy_xport_params _data_xport_params;
    shd::transport::zero_copy_xport_params _ctrl_xport_params;
