 ...
 * Constants
 **********************************************************************/
static const shd::dict<std::string, double> subdev_bandwidth_scalar = map_list_of
    ("A", 1.0)
    ("B", 1.0)
    ("AB", 2.0)
    ("BA", 2.0)
...
static const shd::dict<std::string, std::string> sd_name_to_conn = map_list_of
    ("AB", "IQ")
    ("BA", "QI")
    ("A",  "I")
    ("B",  "Q")
...
SHD_STATIC_BLOCK(reg_basic_and_lf_dboards){
