...
#ifndef INCLUDED_LIBSHD_RFNOC_CONSTANTS_HPP
#define INCLUDED_LIBSHD_RFNOC_CONSTANTS_HPP
...
//! Where the RFNoC block/component definition files lie, relative to SHD_PKG_DIR
static const std::string XML_DEFAULT_PATH = "share/shd/rfnoc";
//! The name of the environment variable storing the bath to the block definition files
static const std::string XML_PATH_ENV = "SHD_RFNOC_DIR";
...
static const shd::dict<std::string, uint32_t> DEFAULT_NAMED_SR = boost::assign::map_list_of
...
#endif /* INCLUDED_LIBSHD_RFNOC_CONSTANTS_HPP */
// vim: sw=4 et:
