...
public:     //Methods
    ...
    static bool is_device_claimed(shd::smini::smini3::smini3_fw_ctrl_iface::sptr fw_ctrl);
    ...
    inline shd::smini::ad936x_manager& get_codec_mgr() const {
        return *_codec_mgr;
    }
    ...
    inline shd::gps_ctrl::sptr get_gps_ctrl(void) {
        return _gps_ctrl;
    }
...
private:
    ...
    shd::smini::smini3::smini3_fw_ctrl_iface::sptr   _fw_ctrl;
    shd::task::sptr                 _claimer_task;
