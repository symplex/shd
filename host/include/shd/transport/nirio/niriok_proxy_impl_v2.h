...
#ifndef INCLUDED_SHD_TRANSPORT_NIRIO_NIRIO_PROXY_IMPL_V2_H
#define INCLUDED_SHD_TRANSPORT_NIRIO_NIRIO_PROXY_IMPL_V2_H
...
namespace shd { namespace nisminirio
{
   ...
   */
   ...
   class SHD_API niriok_proxy_impl_v2 : virtual public niriok_proxy {
    public:
...
#endif /* INCLUDED_SHD_TRANSPORT_NIRIO_NIRIO_PROXY_IMPL_V2_H */
