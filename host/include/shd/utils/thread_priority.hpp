...
#ifndef INCLUDED_SHD_UTILS_THREAD_PRIORITY_HPP
#define INCLUDED_SHD_UTILS_THREAD_PRIORITY_HPP
...
namespace shd{
     ...
     */
    SHD_API void set_thread_priority(
     ...
     */
    SHD_API bool set_thread_priority_safe(
        float priority = default_thread_priority,
        bool realtime = true
    );
...
#endif /* INCLUDED_SHD_UTILS_THREAD_PRIORITY_HPP */
