...
#ifndef INCLUDED_LIBSHD_SMINI_COMMON_CONSTRAINED_DEV_ARGS_HPP
#define INCLUDED_LIBSHD_SMINI_COMMON_CONSTRAINED_DEV_ARGS_HPP
    ...
    public: //Types
        ...
        public:
            ...
            inline virtual std::string to_string() const {
                ...
                SHD_ASSERT_THROW(index < _str_values.size());
...
#endif /* INCLUDED_LIBSHD_SMINI_COMMON_CONSTRAINED_DEV_ARGS_HPP */
