...
#ifndef INCLUDED_SHD_TRANSPORT_BUFFER_POOL_HPP
#define INCLUDED_SHD_TRANSPORT_BUFFER_POOL_HPP
...
namespace shd{ namespace transport{
     ...
     */
    class SHD_API buffer_pool : boost::noncopyable{
    public:
...
#endif /* INCLUDED_SHD_TRANSPORT_BUFFER_POOL_HPP */
