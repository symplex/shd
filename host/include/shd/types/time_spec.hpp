...
#ifndef INCLUDED_SHD_TYPES_TIME_SPEC_HPP
#define INCLUDED_SHD_TYPES_TIME_SPEC_HPP
...
namespace shd{
     ...
     */
    class SHD_API time_spec_t : boost::additive<time_spec_t>, boost::totally_ordered<time_spec_t>{
    public:
    ...
    SHD_API bool operator==(const time_spec_t &, const time_spec_t &);

    //! Implement less_than_comparable interface
    SHD_API bool operator<(const time_spec_t &, const time_spec_t &);

    SHD_INLINE time_t time_spec_t::get_full_secs(void) const{
        return this->_full_secs;
    }

    SHD_INLINE double time_spec_t::get_frac_secs(void) const{
        return this->_frac_secs;
    }

} //namespace shd

#endif /* INCLUDED_SHD_TYPES_TIME_SPEC_HPP */
