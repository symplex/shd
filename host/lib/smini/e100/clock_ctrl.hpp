...
#ifndef INCLUDED_SMINI_E100_CLOCK_CTRL_HPP
#define INCLUDED_SMINI_E100_CLOCK_CTRL_HPP
...
public:
     ...
     */
    static sptr make(shd::spi_iface::sptr iface, double master_clock_rate, const bool dboard_clocks_diff);
...
#endif /* INCLUDED_SMINI_E100_CLOCK_CTRL_HPP */
