...
#ifndef INCLUDED_LIBSHD_SMINI_COMMON_APPLY_CORRECTIONS_HPP
#define INCLUDED_LIBSHD_SMINI_COMMON_APPLY_CORRECTIONS_HPP
...
#endif /* INCLUDED_LIBSHD_SMINI_COMMON_APPLY_CORRECTIONS_HPP */
