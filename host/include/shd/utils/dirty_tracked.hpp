...
#ifndef INCLUDED_SHD_UTILS_DIRTY_TRACKED_HPP
#define INCLUDED_SHD_UTILS_DIRTY_TRACKED_HPP
...
namespace shd{
    ...
    public:
         ...
         * Get underlying data
         */
        SHD_INLINE const data_t& get() const {
            return _data;
        }
         ...
         * time it was cleaned?
         */
        SHD_INLINE bool is_dirty() const {
            return _dirty;
        }
         ...
         */
        SHD_INLINE dirty_tracked& operator=(const data_t& value)
        {
         ...
         * type to data type.
         */
        SHD_INLINE dirty_tracked& operator=(const dirty_tracked& source) {
         ...
         */
        SHD_INLINE operator const data_t&() const {
            return get();
        }
...
#endif /* INCLUDED_SHD_UTILS_DIRTY_TRACKED_HPP */
