...
#ifndef INCLUDED_SHD_UTILS_ALGORITHM_HPP
#define INCLUDED_SHD_UTILS_ALGORITHM_HPP
...
namespace shd{
     ...
     */
    template<typename Range> SHD_INLINE Range sorted(const Range &range){
     ...
     */
    template<typename Range> SHD_INLINE Range reversed(const Range &range){
     ...
     */
    template<typename Range, typename T> SHD_INLINE
     ...
     */
    template<typename T> SHD_INLINE T clip(const T &val, const T &bound1, const T &bound2){
...
#endif /* INCLUDED_SHD_UTILS_ALGORITHM_HPP */
