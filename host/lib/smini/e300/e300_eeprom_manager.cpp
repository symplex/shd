...
const mboard_eeprom_t& e300_eeprom_manager::read_mb_eeprom(void)
{
    ...
    _mb_eeprom["product"] = boost::lexical_cast<std::string>(
        shd::ntohx<uint16_t>(map.hw_product));
    _mb_eeprom["revision"] = boost::lexical_cast<std::string>(
        shd::ntohx<uint16_t>(map.hw_revision));
...
const dboard_eeprom_t& e300_eeprom_manager::read_db_eeprom(void)
{
    ...
    _db_eeprom.id = shd::smini::dboard_id_t::from_uint16(
        shd::ntohx<uint16_t>(map.hw_product));
    ...
    uint16_t pid)
{
    switch (pid) {
    case E300_MB_PID:
        return SMINI_E300_MB;

    case E310_SG1_MB_PID:
        return SMINI_E310_SG1_MB;

    case E310_SG3_MB_PID:
        return SMINI_E310_SG3_MB;
