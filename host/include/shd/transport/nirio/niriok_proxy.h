...
#ifndef INCLUDED_SHD_TRANSPORT_NIRIO_NIRIO_INTERFACE_H
#define INCLUDED_SHD_TRANSPORT_NIRIO_NIRIO_INTERFACE_H
...
#include <shd/transport/nirio/nirio_quirks.h>
...
namespace shd { namespace nisminirio
{
   ...
   static inline nirio_scalar_type_t map_int_to_scalar_type(uint32_t scalar_type_as_int)
   {
      ...
      default: SHD_ASSERT_THROW(false); return RIO_SCALAR_TYPE_UL;
      }
   }
   ...
   struct nirio_fifo_info_t {
    ...
    class SHD_API niriok_proxy : public boost::noncopyable {
    public:
...
#endif /* INCLUDED_SHD_TRANSPORT_NIRIO_NIRIO_INTERFACE_H */
