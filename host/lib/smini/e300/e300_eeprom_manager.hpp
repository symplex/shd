...
public:
    ...
    SHD_INLINE const mboard_eeprom_t& get_mb_eeprom()
    {
        return _mb_eeprom;
    }
    ...
    SHD_INLINE const dboard_eeprom_t& get_db_eeprom()
    {
        return _db_eeprom;
    }
    ...
    enum mboard_t {SMINI_E300_MB, SMINI_E310_SG1_MB, SMINI_E310_SG3_MB, UNKNOWN};
