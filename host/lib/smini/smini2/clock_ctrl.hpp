...
class smini2_clock_ctrl : boost::noncopyable{
public:
    typedef boost::shared_ptr<smini2_clock_ctrl> sptr;

    virtual ~smini2_clock_ctrl(void) = 0;
     ...
     * Used to synchronise daisy-chained SMINIs over the MIMO cable
