...
#ifndef INCLUDED_SHD_UTILS_ATOMIC_HPP
#define INCLUDED_SHD_UTILS_ATOMIC_HPP
...
namespace shd{
     ...
     */
    class SHD_API reusable_barrier{
    public:
        ...
        //! Wait on the barrier condition
        SHD_INLINE void wait_others(void)
        {
    ...
    private:
        ...
        SHD_INLINE void check_interrupt(void)
        {
     ...
     */
    SHD_INLINE bool spin_wait_with_timeout(
    ...
    public:
        ...
        SHD_INLINE void release(void){
            _locked.write(0);
        }

        SHD_INLINE bool claim_with_wait(const double timeout){
...
#endif /* INCLUDED_SHD_UTILS_ATOMIC_HPP */
