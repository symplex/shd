...
#ifndef INCLUDED_LIBSHD_RFNOC_STREAMSIG_HPP
#define INCLUDED_LIBSHD_RFNOC_STREAMSIG_HPP
 ...
 */
class SHD_RFNOC_API stream_sig_t {
 public:
    /***********************************************************************
     * Structors
     ***********************************************************************/
    ...
    //          undefined.
    // \throws shd::key_error if the item type is invalid.
...
SHD_INLINE std::ostream& operator<< (std::ostream& out, stream_sig_t stream_sig) {
...
#endif /* INCLUDED_LIBSHD_RFNOC_STREAMSIG_HPP */
// vim: sw=4 et:
