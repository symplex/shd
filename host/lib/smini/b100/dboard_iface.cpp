...
void b100_dboard_iface::write_aux_dac(dboard_iface::unit_t, aux_dac_t which, double value){
    ...
    static const shd::dict<aux_dac_t, b100_codec_ctrl::aux_dac_t> which_to_aux_dac = map_list_of
...
double b100_dboard_iface::read_aux_adc(dboard_iface::unit_t unit, aux_adc_t which){
    static const shd::dict<
        unit_t, shd::dict<aux_adc_t, b100_codec_ctrl::aux_adc_t>
...
void b100_dboard_iface::set_command_time(const shd::time_spec_t& t)
{
    _wb_iface->set_time(t);
}

shd::time_spec_t b100_dboard_iface::get_command_time(void)
{
