...
#ifndef INCLUDED_SHD_TRANSPORT_BOUNDED_BUFFER_HPP
#define INCLUDED_SHD_TRANSPORT_BOUNDED_BUFFER_HPP

#include <shd/transport/bounded_buffer.ipp> //detail
...
#endif /* INCLUDED_SHD_TRANSPORT_BOUNDED_BUFFER_HPP */
