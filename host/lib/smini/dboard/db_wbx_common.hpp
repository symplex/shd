...
#ifndef INCLUDED_LIBSHD_SMINI_DBOARD_DB_WBX_COMMON_HPP
#define INCLUDED_LIBSHD_SMINI_DBOARD_DB_WBX_COMMON_HPP
 ...
 **********************************************************************/
static const shd::dict<std::string, gain_range_t> wbx_rx_gain_ranges = boost::assign::map_list_of
...
#endif /* INCLUDED_LIBSHD_SMINI_DBOARD_DB_WBX_COMMON_HPP */
