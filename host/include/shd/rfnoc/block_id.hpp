...
#ifndef INCLUDED_SHD_TYPES_BLOCK_ID_HPP
#define INCLUDED_SHD_TYPES_BLOCK_ID_HPP
...
namespace shd {
     ...
     */
    class SHD_RFNOC_API block_id_t
    {
    public:
        block_id_t();
        ...
        //
        // Internally, this matches the string with shd::rfnoc::VALID_BLOCKNAME_REGEX.
        ...
        //
        // Internally, this matches the string with shd::rfnoc::VALID_BLOCKID_REGEX.
        ...
        shd::fs_path get_tree_root() const;
...
#endif /* INCLUDED_SHD_TYPES_BLOCK_ID_HPP */
// vim: sw=4 et:
