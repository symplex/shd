...
parser.add_option("--shd-images-path", type="string", dest="shd_images_path", help="Install location for SHD images", default='')
...
codegen_transform['lvbitx_search_paths'] = options.shd_images_path.replace('\\', '\\\\')
