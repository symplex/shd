...
#ifndef INCLUDED_SHD_SMINI_DBOARD_MANAGER_HPP
#define INCLUDED_SHD_SMINI_DBOARD_MANAGER_HPP
 ...
 */
class SHD_API dboard_manager : boost::noncopyable{
public:
...
#endif /* INCLUDED_SHD_SMINI_DBOARD_MANAGER_HPP */
