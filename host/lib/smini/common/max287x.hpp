...
typedef std::map<uint8_t,shd::range_t> vco_map_t;
static const vco_map_t max2871_vco_map =
    boost::assign::map_list_of
    (0,shd::range_t(2767776024.0,2838472816.0))
    (1,shd::range_t(2838472816.0,2879070053.0))
    (1,shd::range_t(2879070053.0,2921202504.0))
    (3,shd::range_t(2921202504.0,2960407579.0))
    (4,shd::range_t(2960407579.0,3001687422.0))
    (5,shd::range_t(3001687422.0,3048662562.0))
    (6,shd::range_t(3048662562.0,3097511550.0))
    (7,shd::range_t(3097511550.0,3145085864.0))
    (8,shd::range_t(3145085864.0,3201050835.0))
    (9,shd::range_t(3201050835.0,3259581909.0))
    (10,shd::range_t(3259581909.0,3321408729.0))
    (11,shd::range_t(3321408729.0,3375217285.0))
    (12,shd::range_t(3375217285.0,3432807972.0))
    (13,shd::range_t(3432807972.0,3503759088.0))
    (14,shd::range_t(3503759088.0,3579011283.0))
    (15,shd::range_t(3579011283.0,3683570865.0))
    (20,shd::range_t(3683570865.0,3711845712.0))
    (21,shd::range_t(3711845712.0,3762188221.0))
    (22,shd::range_t(3762188221.0,3814209551.0))
    (23,shd::range_t(3814209551.0,3865820020.0))
    (24,shd::range_t(3865820020.0,3922520021.0))
    (25,shd::range_t(3922520021.0,3981682709.0))
    (26,shd::range_t(3981682709.0,4043154280.0))
    (27,shd::range_t(4043154280.0,4100400020.0))
    (28,shd::range_t(4100400020.0,4159647583.0))
    (29,shd::range_t(4159647583.0,4228164842.0))
    (30,shd::range_t(4228164842.0,4299359879.0))
    (31,shd::range_t(4299359879.0,4395947962.0))
    (33,shd::range_t(4395947962.0,4426512061.0))
    (34,shd::range_t(4426512061.0,4480333656.0))
    (35,shd::range_t(4480333656.0,4526297331.0))
    (36,shd::range_t(4526297331.0,4574689510.0))
    (37,shd::range_t(4574689510.0,4633102021.0))
    (38,shd::range_t(4633102021.0,4693755616.0))
    (39,shd::range_t(4693755616.0,4745624435.0))
    (40,shd::range_t(4745624435.0,4803922123.0))
    (41,shd::range_t(4803922123.0,4871523881.0))
    (42,shd::range_t(4871523881.0,4942111286.0))
    (43,shd::range_t(4942111286.0,5000192446.0))
    (44,shd::range_t(5000192446.0,5059567510.0))
    (45,shd::range_t(5059567510.0,5136258187.0))
    (46,shd::range_t(5136258187.0,5215827295.0))
    (47,shd::range_t(5215827295.0,5341282949.0))
    (49,shd::range_t(5341282949.0,5389819310.0))
    (50,shd::range_t(5389819310.0,5444868434.0))
    (51,shd::range_t(5444868434.0,5500079705.0))
    (52,shd::range_t(5500079705.0,5555329630.0))
    (53,shd::range_t(5555329630.0,5615049833.0))
    (54,shd::range_t(5615049833.0,5676098527.0))
    (55,shd::range_t(5676098527.0,5744191577.0))
    (56,shd::range_t(5744191577.0,5810869917.0))
    (57,shd::range_t(5810869917.0,5879176194.0))
    (58,shd::range_t(5879176194.0,5952430629.0))
    (59,shd::range_t(5952430629.0,6016743964.0))
    (60,shd::range_t(6016743964.0,6090658690.0))
    (61,shd::range_t(6090658690.0,6128133570.0));
...
public:
        ...
        bool is_int_n)
    {
        ...
        if (_config_for_sync)
        {
            ...
            {
                if (shd::math::fp_compare::fp_compare_epsilon<double>(vco_freq) < vco.second.stop())
                {
                    vco_index = vco.first;
                    break;
                }
            ...
            if (vco_index == 0xFF)
                throw shd::index_error("Invalid VCO frequency");
    ...
    bool is_int_n)
{
    ...
    static const shd::dict<int, typename max287x_regs_t::rf_divider_select_t> rfdivsel_to_enum =
        boost::assign::map_list_of
    ...
    static const shd::range_t int_n_mode_div_range(16,65535,1);
    static const shd::range_t frac_n_mode_div_range(19,4091,1);

    //other ranges and constants from MAX287X datasheets
    static const shd::range_t clock_div_range(1,4095,1);
    static const shd::range_t r_range(1,1023,1);
    static const double MIN_VCO_FREQ = 3e9;
    ...
    SHD_ASSERT_THROW(target_freq > 0);
    double vco_freq = target_freq;
    while (vco_freq < MIN_VCO_FREQ)
    {
        vco_freq *= 2;
    ...
    SHD_ASSERT_THROW(R <= r_range.stop());
    ...
    SHD_ASSERT_THROW(_regs.clock_divider_12_bit <= clock_div_range.stop());
    ...
    SHD_ASSERT_THROW(rfdivsel_to_enum.has_key(RFdiv));
...
{
    if (enabled)
        throw shd::runtime_error("Cycle slip mode not supported on this MAX287x synthesizer.");
}
