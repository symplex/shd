...
#ifndef INCLUDED_LIBSHD_SMINI_GPIO_CORE_200_HPP
#define INCLUDED_LIBSHD_SMINI_GPIO_CORE_200_HPP
...
public:
    ...
    typedef shd::smini::dboard_iface::unit_t unit_t;
    typedef shd::smini::dboard_iface::atr_reg_t atr_reg_t;

    virtual ~gpio_core_200(void) = 0;

    //! makes a new GPIO core from iface and slave base
    static sptr make(
        shd::wb_iface::sptr iface, const size_t base, const size_t rb_addr);
...
public:
    ...
    static sptr make(shd::wb_iface::sptr iface, const size_t);
...
#endif /* INCLUDED_LIBSHD_SMINI_GPIO_CORE_200_HPP */
