...
#ifndef INCLUDED_SMINI1_CODEC_CTRL_HPP
#define INCLUDED_SMINI1_CODEC_CTRL_HPP
...
/*!
 * The smini1 codec control:
 * - Init/power down codec.
 * - Read aux adc, write aux dac.
 */
class smini1_codec_ctrl : boost::noncopyable{
public:
    typedef boost::shared_ptr<smini1_codec_ctrl> sptr;

    static const shd::gain_range_t tx_pga_gain_range;
    static const shd::gain_range_t rx_pga_gain_range;

    virtual ~smini1_codec_ctrl(void) = 0;
     ...
     */
    static sptr make(shd::spi_iface::sptr iface, int spi_slave);
...
#endif /* INCLUDED_SMINI1_CODEC_CTRL_HPP */
