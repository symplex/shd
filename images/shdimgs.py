...
#
"""
Utility module for packaging and handling SHD binary images.
"""
...
SET(SHD_IMAGES_MD5SUM "{}")
SET(SHD_IMAGES_DOWNLOAD_SRC "{}")
"""
...
def get_base_url():
    ...
    if os.environ.get("SHD_IMAGES_BASE_URL") is not None and os.environ.get("SHD_IMAGES_BASE_URL") != "":
        return os.environ.get("SHD_IMAGES_BASE_URL")
    else:
