...
#ifndef INCLUDED_SHD_UTILS_PIMPL_HPP
#define INCLUDED_SHD_UTILS_PIMPL_HPP
 ...
 * The SHD_PIMPL_* macros simplify code overhead for declaring and making pimpls.
 *
