...
#ifndef INCLUDED_SHD_TRANSPORT_USB_DEVICE_HANDLE_HPP
#define INCLUDED_SHD_TRANSPORT_USB_DEVICE_HANDLE_HPP
 ...
 */
class SHD_API usb_device_handle : boost::noncopyable {
public:
...
#endif /* INCLUDED_SHD_TRANSPORT_USB_DEVICE_HANDLE_HPP */
