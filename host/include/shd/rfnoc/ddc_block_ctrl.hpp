...
#ifndef INCLUDED_LIBSHD_RFNOC_DDC_BLOCK_CTRL_HPP
#define INCLUDED_LIBSHD_RFNOC_DDC_BLOCK_CTRL_HPP
 ...
 */
class SHD_RFNOC_API ddc_block_ctrl :
...
{
public:
    SHD_RFNOC_BLOCK_OBJECT(ddc_block_ctrl)

}; /* class ddc_block_ctrl*/

}} /* namespace shd::rfnoc */

#endif /* INCLUDED_LIBSHD_RFNOC_DDC_BLOCK_CTRL_HPP */
