...
class b200_local_spi_core : boost::noncopyable, public shd::spi_iface {
...
public:
    ...
    b200_local_spi_core(shd::wb_iface::sptr iface, perif_t default_perif);
    ...
    static sptr make(shd::wb_iface::sptr iface, perif_t default_perif = CODEC);
...
class b200_ref_pll_ctrl : public shd::smini::adf4001_ctrl {
public:
