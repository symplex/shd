...
#ifndef INCLUDED_SHD_TYPES_RANGES_HPP
#define INCLUDED_SHD_TYPES_RANGES_HPP
...
namespace shd{
     ...
     */
    struct SHD_API meta_range_t : std::vector<range_t>{
...
#endif /* INCLUDED_SHD_TYPES_RANGES_HPP */
