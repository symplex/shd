...
#ifndef INCLUDED_LIBSHD_TRANSPORT_MUXED_ZERO_COPY_IF_HPP
#define INCLUDED_LIBSHD_TRANSPORT_MUXED_ZERO_COPY_IF_HPP
...
#endif /* INCLUDED_LIBSHD_TRANSPORT_MUXED_ZERO_COPY_IF_HPP */
