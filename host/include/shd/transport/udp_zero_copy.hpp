...
#ifndef INCLUDED_SHD_TRANSPORT_UDP_ZERO_COPY_HPP
#define INCLUDED_SHD_TRANSPORT_UDP_ZERO_COPY_HPP
 ...
 */
class SHD_API udp_zero_copy : public virtual zero_copy_if{
public:
    struct buff_params {
...
#endif /* INCLUDED_SHD_TRANSPORT_UDP_ZERO_COPY_HPP */
