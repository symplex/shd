...
void e100_impl::update_rx_subdev_spec(const shd::smini::subdev_spec_t &spec){
...
void e100_impl::update_tx_subdev_spec(const shd::smini::subdev_spec_t &spec){
    fs_path root = "/mboards/0/dboards";
 ...
 * Receive streamer
 **********************************************************************/
rx_streamer::sptr e100_impl::get_rx_stream(const shd::stream_args_t &args_){
 ...
 * Transmit streamer
 **********************************************************************/
tx_streamer::sptr e100_impl::get_tx_stream(const shd::stream_args_t &args_){
    stream_args_t args = args_;
