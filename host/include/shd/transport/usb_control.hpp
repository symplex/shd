...
#ifndef INCLUDED_SHD_TRANSPORT_USB_CONTROL_HPP
#define INCLUDED_SHD_TRANSPORT_USB_CONTROL_HPP

#include <shd/transport/usb_device_handle.hpp>

namespace shd { namespace transport {

class SHD_API usb_control : boost::noncopyable {
public:
...
#endif /* INCLUDED_SHD_TRANSPORT_USB_CONTROL_HPP */
