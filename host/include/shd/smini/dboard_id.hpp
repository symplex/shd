...
#ifndef INCLUDED_SHD_SMINI_DBOARD_ID_HPP
#define INCLUDED_SHD_SMINI_DBOARD_ID_HPP
...
namespace shd{ namespace smini{
    ...
    class SHD_API dboard_id_t : boost::equality_comparable<dboard_id_t>{
    public:
        /*!
     ...
     */
    SHD_API bool operator==(const dboard_id_t &lhs, const dboard_id_t &rhs);

}} //namespace

#endif /* INCLUDED_SHD_SMINI_DBOARD_ID_HPP */
