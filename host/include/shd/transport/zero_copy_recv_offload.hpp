...
#ifndef INCLUDED_SHD_ZERO_COPY_RECV_OFFLOAD_HPP
#define INCLUDED_SHD_ZERO_COPY_RECV_OFFLOAD_HPP
 ...
 */
class SHD_API zero_copy_recv_offload : public virtual zero_copy_if {
public:
