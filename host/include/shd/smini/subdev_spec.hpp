...
#ifndef INCLUDED_SHD_SMINI_SUBDEV_SPEC_HPP
#define INCLUDED_SHD_SMINI_SUBDEV_SPEC_HPP
...
namespace shd{ namespace smini{
     ...
     */
    struct SHD_API subdev_spec_pair_t : boost::equality_comparable<subdev_spec_pair_t>{
    ...
    SHD_API bool operator==(const subdev_spec_pair_t &, const subdev_spec_pair_t &);
     ...
     */
    class SHD_API subdev_spec_t : public std::vector<subdev_spec_pair_t>{
    public:
...
#endif /* INCLUDED_SHD_SMINI_SUBDEV_SPEC_HPP */
