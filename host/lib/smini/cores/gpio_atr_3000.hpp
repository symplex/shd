...
#ifndef INCLUDED_LIBSHD_SMINI_GPIO_CORE_3000_HPP
#define INCLUDED_LIBSHD_SMINI_GPIO_CORE_3000_HPP
...
public:
    ...
    static sptr make(
        ...
        const shd::wb_iface::wb_addr_type base,
        const shd::wb_iface::wb_addr_type rb_addr);
    ...
    static sptr make_write_only(
        shd::wb_iface::sptr iface, const shd::wb_iface::wb_addr_type base);
...
public:
    ...
    typedef shd::smini::dboard_iface::unit_t db_unit_t;
...
#endif /* INCLUDED_LIBSHD_SMINI_GPIO_CORE_3000_HPP */
