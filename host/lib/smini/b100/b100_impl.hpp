...
static const std::string     B100_FW_FILE_NAME = "smini_b100_fw.ihx";
static const std::string     B100_FPGA_FILE_NAME = "smini_b100_fpga.bin";
...
shd::smini::dboard_iface::sptr make_b100_dboard_iface(
 ...
 */
shd::transport::zero_copy_if::sptr usb_zero_copy_make_wrapper(
    shd::transport::zero_copy_if::sptr usb_zc, size_t usb_frame_boundary = 512
);

//! Implementation guts
class b100_impl : public shd::device {
public:
    //structors
    b100_impl(const shd::device_addr_t &);
    ~b100_impl(void);
...
private:
    ...
    boost::shared_ptr<shd::smini::recv_packet_demuxer_3000> _recv_demuxer;
