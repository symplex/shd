...
NIRIO_ERR_INFO(NiRio_Status_CommunicationTimeout, -61046, "An error was detected in the communication between the host computer and the SMINI device. This could be due to a hardware failure on the bus.")
...
NIRIO_ERR_INFO(NiRio_Status_RpcConnectionError, -63040, "A connection could not be established to the specified remote device manager. Ensure that the devices are on, that NI-SMINIRIO software is installed, and that the SMINIRIO server is running and properly configured.")
