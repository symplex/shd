...
#ifndef INCLUDED_SHD_UTILS_SAFE_MAIN_HPP
#define INCLUDED_SHD_UTILS_SAFE_MAIN_HPP
 ...
 * Usage: int SHD_SAFE_MAIN(int argc, char *argv[]){ main code here }
 * \param _argc the declaration for argc
 * \param _argv the declaration for argv
 */
#define SHD_SAFE_MAIN(_argc, _argv) _main(int, char*[]); \
...
#endif /* INCLUDED_SHD_UTILS_SAFE_MAIN_HPP */
