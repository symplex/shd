...
#ifndef INCLUDED_SHD_TRANSPORT_ZERO_COPY_HPP
#define INCLUDED_SHD_TRANSPORT_ZERO_COPY_HPP
...
namespace shd{ namespace transport{
    ...
    public:
         ...
         */
        SHD_INLINE void commit(size_t num_bytes){
            _length = num_bytes;
        }
         ...
         */
        template <class T> SHD_INLINE T cast(void) const{
         ...
         */
        SHD_INLINE size_t size(void) const{
            return _length;
        }

        //! Create smart pointer to a reusable managed buffer
        template <typename T> SHD_INLINE boost::intrusive_ptr<T> make(
    ...
    SHD_INLINE void intrusive_ptr_add_ref(managed_buffer *p){
        ++(p->_ref_count);
    }

    SHD_INLINE void intrusive_ptr_release(managed_buffer *p){
     ...
     */
    class SHD_API managed_recv_buffer : public managed_buffer{
    public:
     ...
     */
    class SHD_API managed_send_buffer : public managed_buffer{
    public:
     ...
     */
    class SHD_API zero_copy_if : boost::noncopyable{
    public:
...
#endif /* INCLUDED_SHD_TRANSPORT_ZERO_COPY_HPP */
