 ...
 * represents each front-end of a TwinRX board. SHD will
 ...
 * TwinRX board. SHD will hold one instance of this
...
public:
    ...
    static dboard_base::sptr make_twinrx_fe(dboard_base::ctor_args_t args)
    {
        ...
        if (container) {
            ...
            throw shd::assertion_error("error creating twinrx frontend");
        }
    }
...
SHD_STATIC_BLOCK(reg_twinrx_dboards)
{
