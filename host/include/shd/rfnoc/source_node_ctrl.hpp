...
#ifndef INCLUDED_LIBSHD_SOURCE_NODE_CTRL_BASE_HPP
#define INCLUDED_LIBSHD_SOURCE_NODE_CTRL_BASE_HPP
 ...
 */
class SHD_RFNOC_API source_node_ctrl;
...
public:
    ...
    size_t connect_downstream(
            ...
            const shd::device_addr_t &args=shd::device_addr_t()
    );
...
#endif /* INCLUDED_LIBSHD_SOURCE_NODE_CTRL_BASE_HPP */
// vim: sw=4 et:
