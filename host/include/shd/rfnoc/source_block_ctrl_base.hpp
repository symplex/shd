...
#ifndef INCLUDED_LIBSHD_RX_BLOCK_CTRL_BASE_HPP
#define INCLUDED_LIBSHD_RX_BLOCK_CTRL_BASE_HPP
 ...
 */
class SHD_RFNOC_API source_block_ctrl_base;
...
public:
     ...
     */
    virtual void issue_stream_cmd(const shd::stream_cmd_t &stream_cmd, const size_t chan=0);
     ...
     * \throws shd::runtime_error if \p block_port is not a valid port
     */
...
#endif /* INCLUDED_LIBSHD_RX_BLOCK_CTRL_BASE_HPP */
// vim: sw=4 et:
