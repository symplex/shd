...
protected:
    ...
    public:
        SHD_DEFINE_SOFT_REG_FIELD(ADDR, /*width*/ 3, /*shift*/ 0);  //[2:0]
    ...
    public:
        SHD_DEFINE_SOFT_REG_FIELD(CLEAR_FIFO,           /*width*/  1, /*shift*/  0);  //[0]
        SHD_DEFINE_SOFT_REG_FIELD(RD_SUPPRESS_EN,       /*width*/  1, /*shift*/  1);  //[1]
        SHD_DEFINE_SOFT_REG_FIELD(BURST_TIMEOUT,        /*width*/ 12, /*shift*/  4);  //[15:4]
        SHD_DEFINE_SOFT_REG_FIELD(RD_SUPPRESS_THRESH,   /*width*/ 16, /*shift*/ 16);  //[31:16]
    ...
    public:
        SHD_DEFINE_SOFT_REG_FIELD(BASE_ADDR, /*width*/ 30, /*shift*/ 0);  //[29:0]
    ...
    public:
        SHD_DEFINE_SOFT_REG_FIELD(ADDR_MASK, /*width*/ 30, /*shift*/ 0);  //[29:0]
    ...
    public:
        SHD_DEFINE_SOFT_REG_FIELD(GO,               /*width*/ 1, /*shift*/ 0);  //[0]
        SHD_DEFINE_SOFT_REG_FIELD(CONTINUOUS_MODE,  /*width*/ 1, /*shift*/ 1);  //[1]
        SHD_DEFINE_SOFT_REG_FIELD(TEST_PATT,        /*width*/ 2, /*shift*/ 4);  //[5:4]
    ...
    public:
        SHD_DEFINE_SOFT_REG_FIELD(MAX_PKTS,         /*width*/ 18, /*shift*/ 0);  //[17:0]
        SHD_DEFINE_SOFT_REG_FIELD(MAX_PKT_SIZE,     /*width*/ 13, /*shift*/ 18); //[30:18]
        SHD_DEFINE_SOFT_REG_FIELD(PKT_SIZE_RAMP,    /*width*/ 1,  /*shift*/ 31); //[31]
    ...
    public:
        SHD_DEFINE_SOFT_REG_FIELD(TX_PKT_DELAY,     /*width*/ 16, /*shift*/ 0);  //[15:0]
        SHD_DEFINE_SOFT_REG_FIELD(RX_SAMP_DELAY,    /*width*/  8, /*shift*/ 16); //[23:16]
    ...
    public:
        SHD_DEFINE_SOFT_REG_FIELD(SID,     /*width*/ 32, /*shift*/ 0);  //[31:0]
...
public:
    ...
    virtual void resize(const uint32_t base_addr, const uint32_t size) {
        //Validate parameters
        if (size < 8192) throw shd::runtime_error("DMA FIFO must be larger than 8KiB");
        uint32_t size_mask = size - 1;
        if (size & size_mask) throw shd::runtime_error("DMA FIFO size must be a power of 2");
    ...
    virtual uint8_t run_ext_bist(
        ...
        if (_has_ext_bist) {
            ...
            if (rx_samp_delay != 0 || tx_pkt_delay != 0 || sid != 0) {
                throw shd::not_implemented_error(
        ...
        if (!_fifo_readback.get_bist_status().finished) {
            throw shd::runtime_error("dma_fifo_core_3000: DRAM BIST state machine is in a bad state.");
        }
