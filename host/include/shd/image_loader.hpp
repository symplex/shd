...
#ifndef INCLUDED_SHD_IMAGE_LOADER_HPP
#define INCLUDED_SHD_IMAGE_LOADER_HPP
...
class SHD_API image_loader : boost::noncopyable{
...
#endif /* INCLUDED_SHD_IMAGE_LOADER_HPP */
