...
#ifndef INCLUDED_LIBSHD_TERMINATOR_NODE_CTRL_BASE_HPP
#define INCLUDED_LIBSHD_TERMINATOR_NODE_CTRL_BASE_HPP
 ...
 * the data coming out.
 */
class SHD_RFNOC_API terminator_node_ctrl;
...
#endif /* INCLUDED_LIBSHD_TERMINATOR_NODE_CTRL_BASE_HPP */
// vim: sw=4 et:
