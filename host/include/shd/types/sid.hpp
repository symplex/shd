...
#ifndef INCLUDED_SHD_TYPES_SID_HPP
#define INCLUDED_SHD_TYPES_SID_HPP
...
namespace shd {
    ...
    public:
        ...
        // Throws shd::value_error if the string is not a valid SID
        // representation.
    ...
    SHD_INLINE std::ostream& operator<< (std::ostream& out, const sid_t &sid) {
...
#endif /* INCLUDED_SHD_TYPES_SID_HPP */
// vim: sw=4 et:
